      ...
      <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 32px" }}>
        ...
        <div className="footer-grid" style={{ marginBottom: "48px" }}>
          ...
          <div>
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 28 28" aria-hidden="true" style={{ flexShrink: 0 }}>
                <defs>
